...
export class BatchEntryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //   this.loginfo = data
    //   this.getBatchProduct();
    //   this.batchentry = {barCode:null, code: '', barcodeId: null, quantity: null, price: null, expiarydate: "", companyid: this.CompanyId, storeid: this.StoreId, productId: 0, product: null, batchno: 0, entrydatetime: "" }
    // })
    // setInterval(() => {
